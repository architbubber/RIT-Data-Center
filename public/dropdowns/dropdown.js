var dropdowns = {
        ...
        "faculty_conference_symposia_role" : ["Session Chair","Reviewer","Participated","Presented"],
        ...
        "fixed_student_activities_pg_type" : ["National","International"],
        "fixed_student_achievement_type" : ["National","International"],
        "fixed_student_achievement_pg_type" : ["National","International"],
        ...
        "fixed_student_conference_publications_pg_conferenceType" : ["National", "International"],
        "fixed_student_journal_publications_journalType":["National","International"],
        "fixed_student_journal_publications_pg_journalType":["National","International"],
        "fixed_student_journal_publications_indexing" : ["Web of Science", "Scopus", "Google Scholar","Others"],
        "fixed_student_journal_publications_pg_indexing" : ["Web of Science", "Scopus", "Google Scholar"],
        "higher_studies_program":["MS", "Mtech", "Others"],
        "fixed_competative_exam_details_status" : ["qualified", "not qualified"],
        "fixed_bos_membership_course" : ["UG","PG"],
        "fixed_boe_membership_course" : ["UG","PG"],
        "funded_projects_dept_projectType" : ["Research", "Consultancy"],
        "student_funded_projects_dept_projectType" : ["Research", "Consultancy"],
        "fixed_placement_details_pg_on_off_Campus" : ["On Campus", "Off Campus"] 
